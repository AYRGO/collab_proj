...
<body class="bg-gray-100">
    ...
    <div class="ml-72 py-8 mr-10">
        ...
        <h6 class="text-3xl font-semibold mb-4 text-gray-800">Applicants</h6>
                        ...
                        <tr class="hover:bg-gray-100 transition duration-300 ease-in-out">
                            ...
                            <td class="text-center py-3 border-t border-gray-300">
                                <?php if ($user['valid_id']): ?>
                                    <a href="../../include/registration_code/<?php echo htmlspecialchars($user['valid_id']); ?>"
                                        target="_blank" class="text-blue-600 hover:underline">View</a>
                                <?php else: ?>
                                    No file
                                <?php endif; ?>
                            ...
                            <td class="text-center py-3 border-t border-gray-300">
                                <?php if ($user['photo']): ?>
                                    <a href="../../include/registration_code/<?php echo htmlspecialchars($user['photo']); ?>"
                                        target="_blank" class="text-blue-600 hover:underline">View</a>
                                <?php else: ?>
                                    No photo
                                <?php endif; ?>
        ...
        <div class="py-12">
            <h1 class="text-3xl font-semibold mb-4 text-gray-800">Applicant's Guardian</h1>
                ...
                <table class="w-full table-auto border-collapse">
                    <thead class="bg-gradient-to-r from-blue-800 to-indigo-500 text-white text-lg">
                        <tr>
                            ...
                            <th class="py-3 px-4 text-left font-semibold border-r border-gray-300">PWD Application ID
                            </th>
