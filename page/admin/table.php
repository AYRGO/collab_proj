...
try {
    // Select all users from the user_registration table
    $sql = "SELECT id, fname, lname, email, contact, usertype, created_at FROM user_registration";
...
<body class="bg-gray-100">
            ...
            <table class="min-w-full table-auto border-collapse">
                ...
                <thead class="bg-gradient-to-r from-blue-500 to-indigo-500 text-white text-lg">
                    <tr>
                        ...
                        <th class="p-4 text-left font-semibold border-r border-gray-300">Created At</th>
    ...
    <div class="ml-72 py-8 mr-10">
        <h1 class="text-3xl font-semibold mb-4 text-gray-800">User's Feedback</h1>
        ...
        <div class="overflow-x-auto bg-white shadow-lg rounded-lg border border-gray-200">
            <table class="min-w-full table-auto border-collapse">
                ...
                <thead class="bg-gradient-to-r from-blue-500 to-indigo-500 text-white text-lg">
                    <tr>
                        <th class="p-4 text-left font-semibold border-r border-gray-300">ID</th>
                        <th class="p-4 text-left font-semibold border-r border-gray-300">User ID</th>
                        <th class="p-4 text-left font-semibold border-r border-gray-300">First Name</th>
                        <th class="p-4 text-left font-semibold border-r border-gray-300">Last Name</th>
                ...
                <tbody>
                    <?php foreach ($feedbacks as $feedback): ?>
                        <tr class="hover:bg-gray-100 transition duration-300 ease-in-out">
                            ...
                            <td class="text-center py-3 border-t border-gray-300">
                                <?php echo htmlspecialchars($feedback['user_id']); ?>
                            </td>

                            <td class="text-center py-3 border-t border-gray-300">
                                <?php echo htmlspecialchars($feedback['fname']); ?>
                            </td>

                            <td class="text-center py-3 border-t border-gray-300">
                                <?php echo htmlspecialchars($feedback['lname']); ?>
                            </td>
