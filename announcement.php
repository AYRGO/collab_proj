            ...
            <div class="pb-12 text-gray-800">
                ...
                <div id="controls-carousel" class="relative w-full" data-carousel="static">
                    ...
                    <div class="relative h-56 overflow-hidden rounded-lg md:h-80">
                        ...
                        <div class="hidden duration-700 ease-in-out py-4" data-carousel-item="active">
                            <div class="flex gap-8 px-16">
                                ...
                                <div class="flex items-start gap-2 border-2 border-blue-900 p-6 rounded-2xl shadow-md w-full cursor-pointer hover:shadow-xl transition duration-300 transform ease-in-out hover:scale-105"
                                    ...
                                    <!-- company icon -->
                                    <div class="w-[100px]">
                                        <img src="img/jobs/ttec.png" class="w-full h-20 object-contain"
                                            alt="TTEC Icon Logo">
                                    </div>
                                    <!-- job details -->
                                    <div>
                        ...
                        <!-- Item 2 -->
                        <div class="hidden duration-700 ease-in-out py-4">
                            <div class="flex gap-8 px-16">
                                <!-- first job -->
                                <div class="flex items-start gap-2 border-2 border-blue-900 p-6 rounded-2xl shadow-md w-full cursor-pointer hover:shadow-xl transition duration-300 transform ease-in-out hover:scale-105"
                                    id="ttecBox">
                    ...
                    <!-- Slider controls -->
                    <button type="button"
                        class="absolute -top-16 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none"
                        data-carousel-prev>
                        <span
                    ...
                    <button type="button"
                        class="absolute -top-16 end-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none"
                        data-carousel-next>
                        <span
                            class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                            <svg class="w-4 h-4 text-white dark:text-gray-800 rtl:rotate-180" aria-hidden="true"
