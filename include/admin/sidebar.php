    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-blue-950">
        ...
        <ul class="space-y-2 font-medium pt-4">
            ...
            <ul class="ml-4 hidden" id="tableDropdown">
                <li>
                    <a href="table.php?page=user_registration" class="flex items-center p-2 rounded-lg <?php
                    echo ($page == 'user_registration') ? 'text-white bg-gray-600' : 'text-gray-300 hover:bg-gray-700 hover:text-white';
                    ?> group">
                        <span class="ms-3">User Registration</span>
                    </a>
                </li>
                <li>
