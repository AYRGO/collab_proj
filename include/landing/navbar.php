        ...
        <div class="hidden sm:ml-6 md:flex sm:items-center sm:justify-center flex-grow sm:hidden">
            <div class="flex items-center md:space-x-0 lg:space-x-1 xl:space-x-4">
                <div class="relative group">
                    ...
                    <!-- <div
                        class="hidden dropdown group-hover:block absolute w-[300px] bg-white rounded-lg shadow-lg top-8">
                        <ul class="p-3 space-y-3">
                            <li><a href="#" class="block hover:bg-gray-400 hover:text-white p-2 rounded">Overview</a>
                            </li>
                            <li><a href="#" class="block hover:bg-gray-400 hover:text-white p-2 rounded">Vision</a>
                            </li>
                            <li><a href="#" class="block hover:bg-gray-400 hover:text-white p-2 rounded">Mission</a>
                            </li>
                        </ul>
                    </div> -->
                </div>
...
<!-- 
                <a href="#"
                    class="rounded-md px-3 py-2 text-md font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Forum</a> -->
        ...
        <div class="flex items-center gap-2">
            ...
            <div  class="group cursor-pointer">
                ...
                <div
                        ...
                        <ul class="p-3 space-y-3">
                            <li><a href="page/user/index.php" class="block hover:bg-gray-400 hover:text-white p-2 rounded">Profile</a>
                            </li>
                            <li><a href="page/user/usersetting.php" class="block hover:bg-gray-400 hover:text-white p-2 rounded">Settings</a>
                            </li>
