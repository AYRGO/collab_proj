        ...
        <div class="flex items-center gap-2">
            ...
            <?php else: ?>
                ...
                <div class="group cursor-pointer relative">
                    <img class="h-8 w-8 rounded-full" id="profileIcon" src="<?php echo isset($_SESSION['user']['photo']) && !empty($_SESSION['user']['photo']) ? $_SESSION['user']['photo'] : 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80'; ?>" alt="Profile picture">
